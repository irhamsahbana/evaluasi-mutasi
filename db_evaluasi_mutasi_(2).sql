...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 25 Mar 2020 pada 09.21
...
ALTER TABLE `tb_administrator`
  ...
  ADD KEY `tb_administrator_ibfk_1` (`nip`),
...
ALTER TABLE `tb_approval_committee`
  ...
  ADD KEY `tb_approval_committee_ibfk_1` (`nip`);

--
-- Indeks untuk tabel `tb_approvement`
--
ALTER TABLE `tb_approvement`
  ADD KEY `tb_approvement_ibfk_1` (`id_usulan`),
  ADD KEY `tb_approvement_ibfk_2` (`nip`),
  ADD KEY `tb_approvement_ibfk_3` (`id_approval`);
...
ALTER TABLE `tb_pegawai`
  ...
  ADD KEY `tb_pegawai_ibfk_2` (`id_sebutan_jabatan`);
...
ALTER TABLE `tb_usulan_evaluasi`
  ...
  ADD KEY `tb_usulan_evaluasi_ibfk_1` (`id_administrator`);

--
-- Indeks untuk tabel `tb_usulan_evaluasi_approval`
--
ALTER TABLE `tb_usulan_evaluasi_approval`
  ADD KEY `tb_usulan_evaluasi_approval_ibfk_1` (`id_usulan`),
  ADD KEY `tb_usulan_evaluasi_approval_ibfk_2` (`id_approval`),
  ADD KEY `tb_usulan_evaluasi_approval_ibfk_3` (`id_posisi`);
...
--
ALTER TABLE `tb_administrator`
  ADD CONSTRAINT `tb_administrator_ibfk_1` FOREIGN KEY (`nip`) REFERENCES `tb_pegawai` (`nip`) ON UPDATE CASCADE,
...
--
ALTER TABLE `tb_approval_committee`
  ADD CONSTRAINT `tb_approval_committee_ibfk_1` FOREIGN KEY (`nip`) REFERENCES `tb_pegawai` (`nip`) ON UPDATE CASCADE;

--
-- Ketidakleluasaan untuk tabel `tb_approvement`
--
ALTER TABLE `tb_approvement`
  ADD CONSTRAINT `tb_approvement_ibfk_1` FOREIGN KEY (`id_usulan`) REFERENCES `tb_usulan_evaluasi` (`id_usulan`) ON UPDATE CASCADE,
  ADD CONSTRAINT `tb_approvement_ibfk_2` FOREIGN KEY (`nip`) REFERENCES `tb_pegawai` (`nip`) ON UPDATE CASCADE,
  ADD CONSTRAINT `tb_approvement_ibfk_3` FOREIGN KEY (`id_approval`) REFERENCES `tb_approval_committee` (`id_approval`) ON UPDATE CASCADE;
...
--
ALTER TABLE `tb_usulan_evaluasi_approval`
  ADD CONSTRAINT `tb_usulan_evaluasi_approval_ibfk_1` FOREIGN KEY (`id_usulan`) REFERENCES `tb_usulan_evaluasi` (`id_usulan`) ON UPDATE CASCADE,
  ADD CONSTRAINT `tb_usulan_evaluasi_approval_ibfk_2` FOREIGN KEY (`id_approval`) REFERENCES `tb_approval_committee` (`id_approval`) ON UPDATE CASCADE,
